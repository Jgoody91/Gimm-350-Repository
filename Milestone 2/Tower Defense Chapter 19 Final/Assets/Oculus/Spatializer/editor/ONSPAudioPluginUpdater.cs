...
class ONSPAudioPluginUpdater
{
    ...
    private static string GetSpatializerPluginsRootPath()
    {
        ...
        string spatializerPluginsPath = System.IO.Path.GetFullPath(System.IO.Path.Combine(ovrPath, "../Spatializer/Plugins"));
    ...
    private static void AttemptSpatializerPluginUpdate(bool triggeredByAutoUpdate)
    {
        ...
        string newX86PluginPath = System.IO.Path.GetFullPath(System.IO.Path.Combine(pluginsPath, "x86/AudioPluginOculusSpatializer.dll.new"));
        string newX64PluginPath = System.IO.Path.GetFullPath(System.IO.Path.Combine(pluginsPath, "x86_64/AudioPluginOculusSpatializer.dll.new"));
        if (File.Exists(newX86PluginPath) || File.Exists(newX64PluginPath))
        {
            ...
            if (userAcceptsUpdate)
            {
                ...
                string curX86PluginPath = System.IO.Path.Combine(pluginsPath, "x86/AudioPluginOculusSpatializer.dll");
                ...
                string curX64PluginPath = System.IO.Path.Combine(pluginsPath, "x86_64/AudioPluginOculusSpatializer.dll");
